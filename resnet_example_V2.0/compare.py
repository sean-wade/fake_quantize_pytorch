...
CKPT_PATH = '/home/yxchen/models/resnet18/resnet18-perchannel.pt'
input_npy_path = '/home/yxchen/models/resnet18/compare-data/resnet18_input_8bit.npy'
output_npy_path = '/home/yxchen/models/resnet18/compare-data/resnet18_output_8bit.npy'
...
if __name__ == "__main__":
    ...
    def forward_hooker(name):
        def hook_func(module, input, output):
            if isinstance(module, (qm.QConv2d_d, qm.QBatchNorm2d_d, qm.QLinear_d, qm.QReLU)):
                np.save('/home/yxchen/models/resnet18/compare-data/'
