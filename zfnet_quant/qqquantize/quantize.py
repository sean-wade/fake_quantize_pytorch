...
from qqquantize.observers.minmaxchannelsobserver import MovingAverageMinMaxActChannelsObserver
from qqquantize.observers.minmaxobserver import MovingAverageMinMaxObserver
...
class ModelConverter:
    ...
    def _propagate_qconfig(self, model):
        ...
        for name, mod in model.named_modules():
            ...
            if 'm.' in name:                                                 # 在此处可改为网络的最后一层的name
